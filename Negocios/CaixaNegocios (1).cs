...
namespace Negocios
{
    public class CaixaNegocios
    {
        ...
        public CaixaFecharInfo ConsultarCaixaFecharUltimo(int idcaixa)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                accessDbMySql.AddParametrosMySql("@idcaixa", idcaixa);

                DataTable dataTable = accessDbMySql.dataTableMySql("spConsultarCaixaFecharUltimo");

                if (dataTable != null)
                    return PreencherCaixaFechar(dataTable)[0];
                else
                    return null;
            }
            else
        ...
        public int InsertCaixaTurno(CaixaTurnoInfo caixaTurnoInfo)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                ...
                accessDbMySql.AddParametrosMySql("@func", caixaTurnoInfo.caixaturnoidfunc);
        ...
        public int InsertSangria(SangriaInfo sangriaInfo)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                accessDbMySql.AddParametrosMySql("@id", sangriaInfo.sangriaid);
                accessDbMySql.AddParametrosMySql("@caixa", sangriaInfo.sangriaidcaixa);
        ...
        public CaixaDiaColecao ConsultarCaixaDiaTurno(int idturno)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                ...
                if (dataTable != null)
                    return PreencherCaixaDiaTurno(dataTable);
                else
                    return null;
            }
            else
        ...
        public CaixaAbrirInfo ConsultarCaixaAberto(int idunid)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                accessDbMySql.AddParametrosMySql("@idunid", idunid);
        ...
        public int InsertCaixaFechar(CaixaFecharInfo caixaFecharInfo)
        {
            if (accessDbMySql.Conectar(EmpConexao))
            {
                accessDbMySql.AddParametrosMySql("@abrir", caixaFecharInfo.caixafecharidabrir);
                ...
                return accessDbMySql.ExecutarScalarMySql("spInsertCaixaFechar");
            }
            else
                return 0;
        }
        ...
        private CaixaFecharColecao PreencherCaixaFechar(DataTable dataTable)
        {
            CaixaFecharColecao caixaFecharColecao = new CaixaFecharColecao();
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                CaixaFecharInfo caixaFecharInfo = new CaixaFecharInfo
                {
                    ...
                    caixafecharid = Convert.ToInt32(row["caixafecharid"]),
                    caixafecharidabrir = Convert.ToInt32(row["caixafecharidabrir"]),
                ...
                caixaFecharColecao.Add(caixaFecharInfo);
            }

            return caixaFecharColecao;
        }
        ...
        private CaixaTurnoColecao PreencherCaixaTurno(DataTable dataTable)
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                CaixaTurnoInfo caixaTurnoInfo = new CaixaTurnoInfo
                {
                    ...
                    caixaturnoidfunc = Convert.ToInt32(row["caixaturnoidfunc"]),
